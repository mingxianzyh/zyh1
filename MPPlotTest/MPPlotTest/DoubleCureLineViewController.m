//
//  DoubleCureLineViewController.m
//  MPPlotTest
//
...
@interface DoubleCureLineViewController ()

@end

@implementation DoubleCureLineViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"双折线(圆滑)";
...
- (NSString *)titleOfXcale:(NSInteger)xIndex{
    return [NSString stringWithFormat:@"%d 月",xIndex+1];
}
...
- (NSArray *)valuesForLineIndex:(NSInteger)index{
    ...
    switch (index) {
        case 0:{
            array = @[@2.5,@2.6,@2.8,@3,@3.3,@3,@3.6,@3.8,@3.2,@3.6,@4,@4.5];
        }
            break;
        case 1:{
            array = @[@5.5,@1.6,@3.8,@2,@3.3,@3.5,@3.6,@5.8,@1.2,@3.8,@4,@6.5];
        }
            break;
